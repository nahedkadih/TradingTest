...
namespace TestProject3
{
    ...
    public class UnitTest1
    {
        ...
        public void TestMethod1()
        {
            ...
            TradingEngine0.Reset();

            TradingEngine0.ExecuteCommand("BUY GFD 1000 10 order1");
            TradingEngine0.ExecuteCommand("BUY GFD 1001 20 order2");
            TradingEngine0.ExecuteCommand("PRINT");
            ...
            TradingEngine0.Reset();
            TradingEngine0.ExecuteCommand("BUY GFD 1000 10 order1");
            TradingEngine0.ExecuteCommand("SELL GFD 900 20 order2");
            TradingEngine0.ExecuteCommand("PRINT");
            Assert.AreEqual("TRADE order1 1000 10 order2 900 10",
            ...
            TradingEngine0.ExecuteCommand("BUY GFD 1000 10 order1");
            TradingEngine0.ExecuteCommand("BUY GFD 1010 10 order2");
            TradingEngine0.ExecuteCommand("SELL GFD 1000 15 order3");
            ...
            TradingEngine0.ExecuteCommand("BUY GFD 1000 10 order1");
            TradingEngine0.ExecuteCommand("BUY GFD 1001 10 order2");
            TradingEngine0.ExecuteCommand("SELL IOC 1000 15 order3");
            TradingEngine0.ExecuteCommand("SELL GFD 1000 15 order4");
            ...
            TradingEngine0.ExecuteCommand("BUY GFD 1000 10 order1");
            TradingEngine0.ExecuteCommand("SELL IOC 900 15 order2");
            TradingEngine0.ExecuteCommand("BUY GFD 1001 10 order3");
            TradingEngine0.ExecuteCommand("BUY GFD 1004 10 order4");
            TradingEngine0.ExecuteCommand("SELL GFD 1000 15 order5");
            ...
            TradingEngine0.ExecuteCommand("BUY GFD 1000 25 order1");
            TradingEngine0.ExecuteCommand("SELL IOC 900 15 order4");
            TradingEngine0.ExecuteCommand("BUY GFD 1001 10 order2");
            TradingEngine0.ExecuteCommand("BUY GFD 1004 10 order3");
            TradingEngine0.ExecuteCommand("MODIFY order1 BUY 1005 10");
            TradingEngine0.ExecuteCommand("SELL GFD 1000 15 order5");
            TradingEngine0.ExecuteCommand("PRINT");
            ...
            TradingEngine0.ExecuteCommand("BUY GFD 1000 6 order1");
            TradingEngine0.ExecuteCommand("BUY GFD 1001 5 order2");
            TradingEngine0.ExecuteCommand("BUY GFD 1004 5 order3");
            TradingEngine0.ExecuteCommand("SELL IOC 900 15 order4");
            TradingEngine0.ExecuteCommand("MODIFY order1 BUY 1005 5");
            TradingEngine0.ExecuteCommand("SELL GFD 1000 15 order5");
            TradingEngine0.ExecuteCommand("BUY GFD 1006 5 order7");
            TradingEngine0.ExecuteCommand("BUY GFD 800 5 order8");
            TradingEngine0.ExecuteCommand("PRINT");
            ...
            TradingEngine0.ExecuteCommand("SELL GFD 1000 5 order5");
            TradingEngine0.ExecuteCommand("BUY GFD 800 5 order8");
            TradingEngine0.ExecuteCommand("PRINT");
